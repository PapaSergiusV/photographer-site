...
var Animation = function () {
    ...
    _createClass(Animation, null, [{
        key: "openWindow",
        value: function openWindow(elem) {
        ...
        key: "closeWindow",
        value: function closeWindow(elem) {
            var ms = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 300;
...
var data = {
    ...
    price: {
        ...
        point: [{ id: 1, about: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit', price: 1900 }, { id: 2, about: 'Voluptate sapiente id distinctio eaque, ea deserunt eius aut tempora', price: 1500 }, { id: 3, about: 'Dolorem iste a quas nihil, dolorum esse quos enim! Dolorem placeat, tempore.', price: 2000 }, { id: 4, about: 'Dolorum esse quos enim! Dolorem placeat', price: 2400 }, { id: 5, about: 'Sapiente id distinctio eaque, ea deserunt eius aut', price: 3400 }]
    },
    menu: [{ id: 1, name: 'home' }, { id: 2, name: 'album' }, { id: 3, name: 'price' }, { id: 4, name: 'contacts' }],
    pictures: [{ id: 1, path: 'https://i.ytimg.com/vi/nGg-qjn5R2I/maxresdefault.jpg' }, { id: 2, path: 'https://i.ytimg.com/vi/iPjhRDHbLt8/maxresdefault.jpg' }, { id: 3, path: 'https://images.wallpaperscraft.ru/image/chekhiya_staryj_gorod_zdaniya_vid_sverkhu_109566_1920x1080.jpg' }, { id: 4, path: 'https://sites.google.com/site/prirodanasevseegooglgfgf/_/rsrc/1463456237313/home/priroda_gory_nebo_ozero_oblaka_81150_1920x1080.jpg' }, { id: 5, path: 'https://cdn.fishki.net/upload/post/2017/12/01/2445298/1-00.jpg' }, { id: 6, path: 'http://www.1366x768.ru/city/10/city-by-the-sea-wallpaper-1366x768.jpg' }, { id: 7, path: 'http://placehold.it/640x480' }, { id: 8, path: 'http://placehold.it/640x480' }, { id: 9, path: 'http://placehold.it/640x480' }, { id: 10, path: 'http://placehold.it/640x480' }, { id: 11, path: 'http://placehold.it/640x480' }, { id: 16, path: 'http://placehold.it/640x480' }],
    text: [{
        id: 'home',
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.state = { page: 'home', PUWIsOpen: false, PUWPicId: 0 };
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.PUWIsOpen ? _react2.default.createElement(_PopUpWindow2.default, { close: this.closePUW, pictures: data.pictures.slice(0, this.state.page === 'home' ? 6 : data.pictures.length), id: this.state.PUWPicId }) : null,
                _react2.default.createElement(_Navbar2.default, { menu: data.menu, toPage: this.toPage, holder: data.holder }),
                _react2.default.createElement(_Content2.default, { request: this.state.page, data: data, openPUW: this.openPUW }),
                _react2.default.createElement(_Footer2.default, null)
            );
        }
    }, {
        key: 'toPage',
        value: function toPage(page) {
            if (page !== this.state.page) this.setState({ page: page });
        }
    }, {
        key: 'closePUW',
        value: function closePUW() {
            this.setState({ PUWIsOpen: false });
        }
    }, {
        key: 'openPUW',
        value: function openPUW(event) {
            try {
...
var Menu = function (_Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var menu = this.props.menu.map(function (x) {
        return _react2.default.createElement(
          "div",
          { key: x.id, onClick: _this2.toPage, className: "col-xs-3 menu-point" },
          x.name
        );
      });
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            "\xA0",
            this.props.holder.firstName,
            " ",
            _react2.default.createElement(
              "span",
              null,
              this.props.holder.lastName
            )
          ),
          _react2.default.createElement(
            "p",
...
var _Pictures = __webpack_require__(32);
  ...
  _createClass(Content, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { ref: 'content' },
        _react2.default.createElement(ContentManager, {
          request: this.props.request,
          data: this.props.data,
          openPUW: this.props.openPUW
        }),
        _react2.default.createElement(_Social2.default, { holder: this.props.data.holder })
      );
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.request !== this.props.request) // Проверка осталась на случай перестройки приложения. При релизе удалить!
        _Animation2.default.openWindow(this.refs.content, 200); // Pop-up window animation
    }
  }, {
    key: 'shouldComponentUpdate',
...
function ContentManager(props) {
  ...
  if (props.request === 'home') {
    content[0] = _react2.default.createElement(
      'div',
      { key: 0, className: 'col-sm-offset-1 col-sm-6' },
      _react2.default.createElement(_Pictures2.default, { request: props.request, pictures: props.data.pictures, count: 6, openPUW: props.openPUW })
    );
    content[1] = _react2.default.createElement(_Text2.default, { key: 1, request: props.request, text: props.data.text });
  } else if (props.request === 'album') {
    content[0] = _react2.default.createElement(
      'div',
      { key: 0, className: 'col-xs-12' },
  ...
  _createClass(Pictures, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < this.props.count; i++) {
        pictures[i % 3][Math.floor(i / 3)] = _react2.default.createElement('img', { alt: '\u0444\u043E\u0442\u043E \u0430\u043B\u044C\u0431\u043E\u043C\u0430', src: this.props.pictures[i].path, id: 'pic' + i, key: i });
      }var colls = [];
      for (var j = 0; j < 3; j++) {
        colls[j] = _react2.default.createElement(
          'div',
          { key: j, className: 'col-sm-4' },
          pictures[j]
        );
      }return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          'div',
          { className: 'pictures', onClick: this.props.openPUW },
          colls
        )
      );
    }
  ...
  _createClass(Social, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "a",
          { href: this.props.holder.instagram },
          _react2.default.createElement("i", { className: "fab fa-instagram" })
        ),
        _react2.default.createElement(
          "a",
          { href: this.props.holder.vk },
          _react2.default.createElement("i", { className: "fab fa-vk" })
        ),
        _react2.default.createElement(
          "a",
          { href: this.props.holder.any },
          _react2.default.createElement("i", { className: "fab fa-whatsapp" })
        )
      );
    }
  }]);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "form",
                        { action: "" },
                        _react2.default.createElement("input", { type: "text", name: "phone", placeholder: "Your phone" }),
                        _react2.default.createElement("input", { type: "text", name: "name", placeholder: "Your name" }),
                        _react2.default.createElement("textarea", { name: "text", placeholder: "Your message" }),
                        _react2.default.createElement(
                            "button",
...
var PopUpWindow = function (_Component) {
  ...
  function PopUpWindow(props) {
    ...
    var _this = _possibleConstructorReturn(this, (PopUpWindow.__proto__ || Object.getPrototypeOf(PopUpWindow)).call(this, props));

    _this.eventPUW = _this.eventPUW.bind(_this);
    _this.state = { path: _this.props.pictures[_this.props.id].path, id: _this.props.id };
    return _this;
  }
  ...
  _createClass(PopUpWindow, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { ref: 'PUW', className: 'PUWindow', onClick: this.closePUW.bind(this, this.props) },
        _react2.default.createElement(
          'div',
          { className: 'PUWContainer' },
          _react2.default.createElement('img', { src: this.state.path, alt: '\u041F\u0440\u0438\u0431\u043B\u0438\u0436\u0435\u043D\u043D\u043E\u0435 \u0444\u043E\u0442\u043E' }),
          _react2.default.createElement(
            'div',
            { className: 'switch', onClick: this.eventPUW },
            _react2.default.createElement(
              'div',
              { className: 'col-xs-3' },
              _react2.default.createElement(
                'div',
                { className: 'switch-field', id: 'toPrev' },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'switch-field', id: 'toNext' },
    ...
    key: 'eventPUW',
    value: function eventPUW(event) {
      var to = event.nativeEvent.toElement.id;
      var idNow = this.state.id;
      if (to === 'toNext') {
        if (idNow + 1 < this.props.pictures.length) this.setState({ path: this.props.pictures[idNow + 1].path, id: idNow + 1 });else this.setState({ path: this.props.pictures[0].path, id: 0 });
      } else if (to === 'toPrev') {
        if (idNow - 1 >= 0) this.setState({ path: this.props.pictures[idNow - 1].path, id: idNow - 1 });else this.setState({ path: this.props.pictures[this.props.pictures.length - 1].path, id: this.props.pictures.length - 1 });
      }
      event.stopPropagation();
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      _Animation2.default.openWindow(this.refs.PUW); // Pop-up window animation
    }
  }, {
    key: 'componentDidUpdate',
    ...
    key: 'closePUW',
    value: function closePUW(props) {
      _Animation2.default.closeWindow(this.refs.PUW);
